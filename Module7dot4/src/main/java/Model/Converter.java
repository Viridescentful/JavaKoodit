...
public class Converter {
    ...
    public String convert(String convertablekey, String convertedkey, String value) {
        if (Double.parseDouble(value) <= 0) {
            ...
            newTransaction.setAmount(Double.parseDouble(value));
            newTransaction.setSourceCurrency(dao.find(convertablekey));
            newTransaction.setTargetCurrency(dao.find(convertedkey));
